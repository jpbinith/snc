...
class MazeEscapeNode(Node):
    ...
    def __init__(self):
        ...
        self.return_sub = self.create_subscription(Empty, '/trigger_home', self.handle_return_home, 10)
    ...
    def publish_status(self, text):
        ...
        self.get_logger().info(f"Status set to: {text}")

    def handle_return_home(self, msg):
        self.get_logger().info("Received return trigger. Stopping exploration and shutting down.")
        self.exploration_started = False
        self.stop()
        self.destroy_node()  # shuts down the node
